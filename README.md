...
Note: "Version 1" files are based on Excel-based queries from the BLS user interface; I then discovered the BLS flat files, which contain more data, and I thus pivoted to the flat files as the main implementation throughout.
